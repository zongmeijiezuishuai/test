    ...
    <div style="padding: 20px;">
        <el-row :gutter="20" class="mgb20">
            <el-col :span="6">
                <el-card>
                    <div class="grid-content">
                        <div class="grid-cont-center" style="color: #DC143C;font-size: 36px;">
                            <div class="grid-num">{{consumerCount}}</div>
                            <div class="grid-text"> 用户总数</div>
                        </div>
                    </div>
                </el-card>
            </el-col>
            <el-col :span="6">
                <el-card>
                    <div class="grid-content">
                        <div class="grid-cont-center" style="color: #6495ED;font-size: 36px;">
            ...
            <el-col :span="6">
                <el-card>
                    <div class="grid-content">
                        <div class="grid-cont-center" style="color: #2E8B57;font-size: 36px;">
            ...
            <el-col :span="6">
                <el-card>
                    <div class="grid-content">
                        <div class="grid-cont-center" style="color: #DAA520;font-size: 36px;">
        ...
        <el-row :gutter="20" class="mgb20">
            <el-col :span="12">
                <div class="mgb" style="font-size: 22px;"><b> 用户性别比例</b></div><br>
                <div style="background-color:white">
                    <ve-pie :data="consumerSex" :theme="options"></ve-pie>
                </div>
            </el-col>
            <el-col :span="12">
                <div class="mgb" style="font-size: 22px;"><b> 歌曲类别分布</b></div><br>
                <div style="background-color:white">
        ...
        <el-row :gutter="20" class="mgb20">
            <el-col :span="12">
                <div class="mgb" style="font-size: 22px;"><b> 歌手性别比例</b></div><br>
                <div style="background-color:white">
                    <ve-pie :data="singerSex"></ve-pie>
                </div>
            </el-col>
            <el-col :span="12">
                <div class="mgb" style="font-size: 22px;"><b> 歌手国籍分布</b></div><br>
                <div style="background-color:white">
